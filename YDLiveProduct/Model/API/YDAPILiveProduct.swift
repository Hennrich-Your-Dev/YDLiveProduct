...
//  YDProduct
//
//  Created by Douglas Hennrich on 11/09/20.
...
public class YDAPILiveProduct: Codable {
    ...
    init(id: String, name: String, component: YDAPILiveProductComponent) {
        self.id = id
        self.name = name
...
class YDAPILiveProductComponent: Codable {
    ...
    init(id: String, type: String, showcaseTitle: String, children: [YDAPILiveProductChild]) {
        self.id = id
        self.type = type
...
class YDAPILiveProductChild: Codable {
    ...
    init(id: String, productID: String, title: String?, type: String?) {
        self.id = id
